...
package io.spring.initializr.spring.conventions.code.kotlin;
 ...
 */
public class KotlinDependenciesConfigurer implements BuildCustomizer<Build> {

	private final Version springBootVersion;

	public KotlinDependenciesConfigurer(Version springBootVersion) {
