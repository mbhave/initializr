 ...
 */
public class SpringBootVersionRepositoriesBuildCustomizer implements BuildCustomizer<Build> {

	private final Version springBootVersion;

	public SpringBootVersionRepositoriesBuildCustomizer(Version springBootVersion) {
