...
import io.spring.initializr.conventions.build.BuildMetadataResolver;
 ...
 */
public class DefaultStarterBuildCustomizer implements BuildCustomizer<Build> {
	...
	public DefaultStarterBuildCustomizer(InitializrMetadata metadata) {
