...
public class ProjectRequestToDescriptionConverter {
	...
	private final ProjectRequestValidator validator;

	private final InitializrMetadataProvider metadataProvider;

	public ProjectRequestToDescriptionConverter(ProjectRequestValidator validator,
	...
	public ProjectDescription convert(BasicProjectRequest request) {
		...
		try {
			...
			description
					.setPlatformVersion(ConceptTranslator.toVersion(springBootVersion));
