...
package io.spring.initializr.conventions.documentation;

import io.spring.initializr.conventions.scm.git.GitIgnore;
 ...
 */
public class HelpDocumentGitIgnoreCustomizer implements GitIgnoreCustomizer {

	private final HelpDocument document;

	public HelpDocumentGitIgnoreCustomizer(HelpDocument document) {
