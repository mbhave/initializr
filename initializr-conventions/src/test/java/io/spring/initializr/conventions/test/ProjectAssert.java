...
package io.spring.initializr.conventions.test;
...
import io.spring.initializr.conventions.test.build.GradleBuildAssert;
import io.spring.initializr.conventions.test.build.GradleSettingsAssert;
import io.spring.initializr.conventions.test.build.PomAssert;
import io.spring.initializr.conventions.test.code.SourceCodeAssert;
